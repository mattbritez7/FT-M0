...
function conection(status) {
  ...
  if (status === 1) {return "Online"}; if (status === 2) {return "Away"}; return "Offline"
}
...
function saludo(idioma) {
  ...
  // Si "idioma" no es ninguno de los anteiores o es `undefined` devuelve "hello!"
  // Tu código:
  if (idioma === "aleman" ) {return "Guten Tag!"}; if (idioma === "mandarin" ) {return "Ni Hao!"}; if (idioma === "ingles") {return "Hello!"};
  return "Hola!"
...
function esEntero(numero) {
  ...
  // Tu código:
    ...
    if(int === numero) {return true} else {return false}
}
